...
Este proyecto no requiere instalar dependencias manualmente (Node.js, Python, gestores de paquetes o bases de datos) en la máquina local.

Todas las dependencias necesarias para cada servicio (frontend, gateway, user service y book service) se instalan automáticamente dentro de sus respectivos contenedores Docker, según lo definido en los archivos Dockerfile y docker-compose.yml.


4) Cómo levantar todo con Docker
------------------------------------------------------
